...
/**
 * lucide-react 1.x dropped brand glyphs entirely, and brand marks have defined
 * shapes anyway, so they are inlined rather than approximated with a generic icon.
 */
